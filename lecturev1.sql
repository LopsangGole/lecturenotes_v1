...
CREATE TABLE IF NOT EXISTS `Course` (
  ...
  `l_id` int(4) NOT NULL,
  `c_nm` varchar(60) NOT NULL,
  `c_subcat` varchar(25) NOT NULL,
  `c_desc` longtext NOT NULL,
  `c_page` int(5) NOT NULL,
  `c_pdf` longtext NOT NULL,
  PRIMARY KEY (`c_id`),
...
INSERT INTO `Course` (`c_id`, `c_nm`, `c_subcat`, `c_desc`, `l_id`, `b_edition`, `b_isbn`, `c_page`, `b_price`, `b_img`, `c_pdf`) VALUES
...
CREATE TABLE IF NOT EXISTS `Lecturer` (
  ...
  'c_id' int(4) NOT NULL,
  `l_nm` varchar(60) NOT NULL,
  `l_subcat` varchar(25) NOT NULL,
  `l_desc` longtext NOT NULL,
  `l_page` int(5) NOT NULL,
  `l_pdf` longtext NOT NULL,
  PRIMARY KEY (`l_id`),
...
INSERT INTO `user` (`u_id`, `u_nm`, `u_unm`, `u_pwd`, `u_gender`, `u_email`, `u_contact`, `u_address`) VALUES
